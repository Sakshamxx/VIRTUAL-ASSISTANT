...
const SITE_MAP: Record<string, { url: string; name: string }> = {
  ...
  hackerblocks: { url: "https://hack.codingblocks.com/app/", name: "HackerBlocks" },
  "hacker blocks": { url: "https://hack.codingblocks.com/app/", name: "HackerBlocks" },
  "coding blocks": { url: "https://hack.codingblocks.com/app/", name: "HackerBlocks" },
